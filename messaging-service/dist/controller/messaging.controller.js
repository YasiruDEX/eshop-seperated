...
exports.disconnectPrisma = exports.getMessageById = exports.deleteMessage = exports.markMessagesAsRead = exports.getSellerConversations = exports.getUserConversations = exports.getConversation = exports.sendMessage = void 0;
const prisma_messaging_1 = require("../../../../generated/prisma-messaging");
const prisma = new prisma_messaging_1.PrismaClient();
/**
 * Send a new message
 * @route POST /messages
 */
    ...
    try {
        ...
        if (!userId || !sellerId || !senderId || !senderType || !message) {
            return res.status(400).json({
                success: false,
                error: "userId, sellerId, senderId, senderType, and message are required fields",
            });
        }
...
const getConversation = async (req, res) => {
    try {
        ...
        console.log(`💬 Fetching conversation between user ${userId} and seller ${sellerId}`);
...
const getSellerConversations = async (req, res) => {
    try {
        ...
        const conversations = Array.from(conversationMap.values());
        console.log(`📦 Found ${conversations.length} conversations for seller ${sellerId}`);
        return res.status(200).json({
            success: true,
            count: conversations.length,
            data: conversations,
...
exports.getSellerConversations = getSellerConversations;
/**

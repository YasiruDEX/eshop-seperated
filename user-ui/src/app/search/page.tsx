...
const SearchPageContent = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <ToastContainer />
      {/* Search Header */}
      <div className="bg-gray-50 border-b-2 border-black py-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-3 mb-2">
            <Search size={32} className="text-black" />
            <h1 className="text-3xl font-black text-black">Search Results</h1>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-8 sm:py-16 flex-grow">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <Link
              href="/"
              className="bg-black text-white px-6 py-2 hover:bg-gray-800 inline-block"
            >
              Back to Home
            </Link>
          </div>

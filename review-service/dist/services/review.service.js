...
exports.getBatchReviewStats = exports.getReviewsByOrderId = exports.markReviewHelpful = exports.getReviewAggregation = exports.getReviewsByItemId = exports.updateCatalogueReviews = exports.submitReview = void 0;
const prisma_review_1 = require("../../../../generated/prisma-review");
const reviewPrisma = new prisma_review_1.PrismaClient();
const submitReview = async (params) => {
    const { itemId, orderId, userId, userName, userEmail, rating, comment, verified = false, } = params;
    // Validate rating
    ...
    await (0, exports.updateCatalogueReviews)(itemId);
    return review;
};
exports.submitReview = submitReview;
const updateCatalogueReviews = async (itemId) => {
    ...
    try {
        ...
        console.log(`✅ Updated catalogue for item ${itemId}: ${reviewCount} reviews, ${averageRating.toFixed(1)} avg rating`);
    }
    catch (error) {
...
exports.updateCatalogueReviews = updateCatalogueReviews;
const getReviewsByItemId = async (itemId) => {
    ...
    // Get aggregated data
    const aggregation = await (0, exports.getReviewAggregation)(itemId);
    return {
        reviews,
        aggregation,
    };
...
const getReviewAggregation = async (itemId) => {
    const reviews = await reviewPrisma.comments.findMany({
        where: { itemId },
        select: { rating: true },
    });
...
exports.getReviewAggregation = getReviewAggregation;
...
const getBatchReviewStats = async (itemIds) => {
    try {
...
exports.getBatchReviewStats = getBatchReviewStats;

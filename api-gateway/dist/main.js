...
apiRouter.use("/user-registration", (0, express_http_proxy_1.default)(AUTH_SERVICE_URL, {
    https: true,
...
apiRouter.use("/seller-registration", (0, express_http_proxy_1.default)(AUTH_SERVICE_URL, {
    https: true,
